...
class Vegetable2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_vegetable2, container, false)
        ...
        calculate.setOnClickListener {
            ...
            if (a.text.isEmpty() || b.text.isEmpty() || c.text.isEmpty()) {
                ...
                val x = a.getText().toString()
                val y = b.getText().toString()
                val z = c.getText().toString()
                val x1 = x.toDouble()
                val x2 = y.toDouble()
                val x3 = z.toDouble()
                val x4: Double?
